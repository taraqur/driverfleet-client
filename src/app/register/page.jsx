...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-[#f8f9fa] dark:bg-[#110e07] pt-20 transition-colors duration-300">
      {/* Background - Very dark with subtle warm/purple glow on the right */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-tr from-white dark:from-[#16130b] via-white/90 dark:via-[#16130b] to-[#f2ca50]/10 dark:to-[#3a1d1d]/30"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[480px] px-6">
        ...
        {/* Form Card */}
        <div className="bg-white/80 dark:bg-[#14120e]/80 backdrop-blur-md border border-black/5 dark:border-white/5 rounded-[12px] p-8 shadow-2xl w-full">
