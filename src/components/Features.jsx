    ...
    <section className="py-20 px-6 md:px-12 max-w-7xl mx-auto bg-[#110e07]">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center text-center p-10 rounded-2xl bg-[#16130b] border border-white/5 hover:border-white/10 transition-colors">
          ...
          <h3 className="font-[family-name:var(--font-inter)] text-[18px] font-bold text-white mb-3">24/7 Support</h3>
          <p className="font-[family-name:var(--font-inter)] text-[15px] text-white/60 leading-relaxed">
        ...
        <div className="flex flex-col items-center text-center p-10 rounded-2xl bg-[#16130b] border border-white/5 hover:border-white/10 transition-colors">
          ...
          <h3 className="font-[family-name:var(--font-inter)] text-[18px] font-bold text-white mb-3">Premium Insurance</h3>
          <p className="font-[family-name:var(--font-inter)] text-[15px] text-white/60 leading-relaxed">
        ...
        <div className="flex flex-col items-center text-center p-10 rounded-2xl bg-[#16130b] border border-white/5 hover:border-white/10 transition-colors">
          ...
          <h3 className="font-[family-name:var(--font-inter)] text-[18px] font-bold text-white mb-3">Luxury Collection</h3>
          <p className="font-[family-name:var(--font-inter)] text-[15px] text-white/60 leading-relaxed">
